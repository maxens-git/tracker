...
namespace TrackerApi.Migrations
{
    ...
    [Migration("20260718162545_AddTmdbSettings")]
    partial class AddTmdbSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tracker.Models.TheaterList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TheaterLists");
                });

            modelBuilder.Entity("Tracker.Models.TheaterListItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TheaterListId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("TheaterListId", "Code")
                        .IsUnique();

                    b.ToTable("TheaterListItems");
                });
            ...
            modelBuilder.Entity("Tracker.Models.TheaterListItem", b =>
                {
                    b.HasOne("Tracker.Models.TheaterList", "TheaterList")
                        .WithMany("Items")
                        .HasForeignKey("TheaterListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TheaterList");
                });
