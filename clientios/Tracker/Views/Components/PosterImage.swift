...
//  Tracker
//
//  Affiche TMDB au ratio 2:3, avec placeholder et chargement asynchrone.
//  La vue impose toujours une boîte 2:3 (avec découpe) pour que toutes les
//  affiches aient exactement la même taille dans une grille.
//
